...
public class Application {
	...
	public void showAllFromFront() {
		...
		for (int i = this._arrayQueue.front(); i < this._arrayQueue.front()+this._arrayQueue.size(); i++)
			System.out.print(this._arrayQueue.findElementByOrder(i+1) + " ");
	...
	public void showFrontElement() {
		System.out
				.println("[Front] 맨 앞 원소는 " + this._arrayQueue.frontElement() + " 입니다.");
	}

	public void showQueueLength() {
		System.out.println("[Length] 큐에는 현재 " + this._arrayQueue.size()
				+ "개의 원소가 있습니다.");
	}
	...
	public void deleteOne() {
		if (this._arrayQueue.isEmpty())
			...
			System.out.println("[DeQueue] 삭제된 원소는 " + this._arrayQueue.deQueue()
					+ " 입니다.");
	}
